...
9. **#536** — **`planning`** joins them, completing the set: a DB-free remote worker
   ...
   for sixteen in total, seventeen once #543 added the split's resume lookup, eighteen once #639 added the dependency gate's reverse-edge read and nineteen once #825 added the worker's own CLI-quota report; see
