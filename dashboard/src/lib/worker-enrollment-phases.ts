 ...
 *
 * Takes the three sets as `readonly string[]` because the read models mirror the
 * phase vocabulary as plain strings (`types/workers.ts`); anything outside the
 * vocabulary simply never matches a phase.
 */
